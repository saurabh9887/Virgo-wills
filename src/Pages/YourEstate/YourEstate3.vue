    ...
    <section class="marital-status-form">
      <div class="container">
        <div class="wrapper pt-45 md-pt-50 pb-20 md-pb-50 row">
          <div class="col-md-6">
            <h1 class="mb-30">Would you like to include a gift to charity?</h1>
            <p class="mb-30">
            ...
            <form action="#" method="POST">
              ...
              <div class="row align-items-start mb-3 mt-30">
                <div class="col-lg-6">
                  <div class="partner-selection">
                    <label class="partner-option">
                      <div class="partner-details bg-white shadow-sm w-100">
                        <div class="check-name">
                          <img src="../../../images/step-1.png" width="200px" />
                        </div>
                        <div class="checkamrk">
                          <input
                            type="checkbox"
                ...
                <div class="col-lg-6">
                  <div class="partner-selection">
                    <label class="partner-option">
                      <div class="partner-details bg-white shadow-sm w-100">
                        <div class="check-name">
                          <img src="../../../images/step-2.png" width="100px" />
                        </div>
                        <div class="checkamrk">
                          <input
                            type="checkbox"
                ...
                <div class="col-lg-6">
                  <div class="partner-selection">
                    <label class="partner-option">
                      <div class="partner-details bg-white shadow-sm w-100">
                        <div class="check-name">
                          <img src="../../../images/step-3.png" width="100px" />
                        </div>
                        <div class="checkamrk">
                          <input
                            type="checkbox"
                ...
                <div class="col-lg-6">
                  <div class="partner-selection">
                    <label class="partner-option">
                      <div class="partner-details bg-white shadow-sm w-100">
                        <div class="check-name">
                          <img src="../../../images/step-4.png" width="130px" />
                        </div>
                        <div class="checkamrk">
                          <input
                            type="checkbox"
                ...
                <div class="col-lg-12">
                  <div class="partner-selection">
                    <label class="partner-option">
                      <div class="partner-details w-100">
                        <div class="check-name">
                ...
                <div class="col-lg-12">
                  <div class="partner-selection">
                    <label class="partner-option col-md-6 mx-auto">
                                ...
                                <form id="newPartnerForm" action="#">
                                  <div class="row">
                                    <div class="col-12">
                                      ...
                                      >
                                        <label
                                          ><b>Search for a charity</b></label
                                        >
                                        <input
                                          type="text"
                                          id="partnerName"
              ...
              <div class="text-center mb-3 button-flex">
                <button
                  ...
                  onclick="location.href='your-estate2.html'"
                >
                  Back
                </button>
