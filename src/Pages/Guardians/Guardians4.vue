      ...
      <div class="row">
          ...
          <div class="ps-xxl-4 wow fadeInRight">
            <div class="title-one">
              <h3 class="text-center mb-30">
                Does SUREKHA already have parental responsibility for Dev?
              </h3>
            </div>
            <p class="mt-40 md-mt-20 mb-40 md-mb-20">
              All mothers have parental responsibility. Fathers have parental
              responsibility if they are married to the mother at the time of
              birth or listed on the birth certificate. Partners of the same sex
        ...
        <div class="col-lg-6">
          ...
          >
            <div class="title-one">
              <h3 class="text-center mb-30">
                Does SUREKHA already have parental responsibility for Heet?
              </h3>
            </div>
            <p class="mt-40 md-mt-20 mb-40 md-mb-20">
              All mothers have parental responsibility. Fathers have parental
              ...
              <ul class="btn-group w-100 style-none d-flex">
                <li class="me-2 w-100">
                  <input
                    ...
                    checked
                  />
                  <label class="btn btn-outline-dark w-100" for="option1"
                    >Yes</label
                  >
                </li>
                <li class="me-2 w-100">
                  <input
                    ...
                    autocomplete="off"
                  />
                  <label class="btn btn-outline-dark w-100" for="option2"
                    >No</label
                  >
                </li>
              </ul>
      ...
      <div class="wrapper pt-45 md-pt-50 pb-20 md-pb-50">
        ...
        <div class="text-center mb-3 button-flex">
          <button
            ...
            onclick="location.href='/guardians3'"
          >
            Back
          </button>
          <!-- <button type="button" class="btn btn-primary mb-3 btn-right py">Save and continue</button> -->
          <a href="/guardians5" class="btn btn-primary mb-3 btn-right py"
            >Save and continue</a
          >
        </div>
      </div>
