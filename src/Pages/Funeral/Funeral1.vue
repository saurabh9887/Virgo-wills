    ...
    <section class="marital-status-form">
      <div class="container">
        <div class="wrapper pt-45 md-pt-50 pb-20 md-pb-50 row">
          <div class="col-md-6">
            <h1 class="mb-30">Do you have a pre-paid funeral plan?</h1>
            <p class="mb-30">
              A funeral plan means you’ve arranged and paid for your funeral
              upfront.
            </p>
            ...
            <h3 class="mb-30">Would you like a free funeral plans guide?</h3>
            <p class="mb-30">
              Even if you’re not ready to set up a plan just yet, we can send
              you our free guide and keep you up to date with any tips,
              discounts and news from Farewill Funerals in the future.
            </p>
            <p>
              As a Farewill customer, you will also receive <b> £150 </b>off
              your funeral plan.
            </p>
