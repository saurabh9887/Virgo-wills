      ...
      <div class="container">
        <div class="wrapper pt-45 md-pt-50 pb-20 md-pb-50 row">
          <div class="col-md-6">
            ...
            <p class="mb-30">
              Although it’s not legally binding, letting the people close to you
              know what you’d like for your funeral, can help them make
          ...
          <div class="text-center mb-3 button-flex">
            <button
              ...
              onclick="location.href='/funeral1'"
            >
              Back
            </button>
