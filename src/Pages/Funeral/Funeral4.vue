      ...
      <div class="container">
        <div class="wrapper pt-45 md-pt-50 pb-20 md-pb-50 row">
          <div class="col-md-6">
            ...
            <p>
              This can be anything you like, from music and religious
              preferences, to firework displays and fancy dress.
            </p>
            ...
            <p>
              Expressing your wishes aren’t legally binding, but they can be
              very helpful for the people close to you.
            </p>
            <p>Your wishes (Optional)</p>
            <textarea class="form-control" rows="5"></textarea>
          </div>

          <div class="col-lg-6"></div>

          <div class="text-center mb-3 button-flex mt-20">
            <button
              type="button"
              class="btn btn-primary mb-3 btn-left py"
              onclick="location.href='/funeral3'"
            >
              Back
            </button>
